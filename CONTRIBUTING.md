...
This outlines how to propose a change to visor. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("CityRiverSpaces/visor", fork = TRUE)`.
...
Please note that the visor project is released with a [Contributor Code
of Conduct](https://cityriverspaces.github.io/visor/CODE_OF_CONDUCT.md).
